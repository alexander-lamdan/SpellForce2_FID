...
myCrossoverX = 329.555
myCrossoverY = 378.944
...
State
{
	...
	OnOneTimeEvent
	{
		Conditions =
		{
			...
			BuildingIsAlive {Tag = "WS_sharandal_tower_01"},
		},
		Actions =
		{
	...
	OnIdleRunHomeFake
	{
		...
		Conditions =
		{
			...
			MapFlagIsTrue {Name = "mf_P504_AllAliveTower1"},
		},
	...
	--{
		...
		--Actions =
		--{
			--MapFlagSetFalse {Name = "mf_P504_AllAliveTower1"},
--		},
	--},
